...
$.fn.zabuto_calendar = function (options) {
    ...
    this.each(function () {
        ...
        function drawCalendar() {
            ...
            var $containerHtml = $('<div class="zabuto_calendar" style="width: 250px;"></div>');
            ...
            for (var wk = 0; wk < weeksInMonth; wk++) {
                ...
                for (var dow = 0; dow < 7; dow++) {
                    if (dow < firstDow || currDayOfMonth > lastDayinMonth) {
                        ...
                        var $dayElement = $('<span class="pull-right"><a style="color:#000000;" href="./agenda?filial=<?php echo $filial; ?>&data=' + dayId + '<?php echo $user; ?>" target="_self">' + currDayOfMonth + '</a></span>');
                        //var $dayElement = $('<div id="' + dayId + '" class="day" ></div>');
                        ...
                        if (isToday(year, month, currDayOfMonth)) {
                            ...
                            if ($calendarElement.data('showToday') === true) {
                                $dayElement.html('<span class="badge badge-today" style="background: #1EABA9;"><a style="color:#000000;" href="./agenda?filial=<?php echo $filial; ?>&data=' + dayId + '<?php echo $user; ?>" target="_self">' + currDayOfMonth + '</a></span>');
                            }
                        }
